		...
		const accountHtml = `
            <div class="table__row">
                ...
                <div class="table__cell table__cell_content_deposits" data-label="Deposits">
                    ...
                    <button class="table__detail-btn" onclick="openDetailInfoDeposits(${
						account.id
					})"></button>
                </div>
                <div class="table__cell table__cell_content_withdraws" data-label="Withdraws">
                    ...
                    <button class="table__detail-btn" onclick="openDetailInfoWithdraws(${
						account.id
					})"></button>
                </div>
			...
			account.status || "Выберите"
                    ...
                    <button class="table__detail-btn" onclick="openDetailInfoStatus(${
						account.id
					})"></button>
                </div>
            </div>`;
			...
			try {
                ...
                <div class="popup__transaction-block">
                    <div class="popup__transaction-size">
                        <p class="popup__transaction-currency">${
							obj.currency
						}</p>
                        <p class="popup__transaction-amount">${
							obj.amount || "N/A"
						}</p>
                    </div>
                    ...
                    <div class="popup__bet-block">
                        ...
                        <div class="popup__bet-info">
                            ...
                            <div class="popup__bet-size">
                                ...
                                <p class="popup__payout-currency">${
									obj.currency || "N/A"
								}</p>
                                <p class="popup__payout-amount">${
									obj.payout || "N/A"
								}</p>
                            </div>
                        </div>
                ...
                <div class="popup__session-block">
                    <div class="popup__session-info">
                        <div class="popup__session-token-block">
                            <p class="popup__session-token" onclick="redirectionToToken(this)">${
								obj.token
							}</p>
                        ...
                        <p class="popup__session-hash" onclick="redirectionToHash(this)">${
							obj.hash
						}</p>
                    </div>
				...
				const accountHtml = `
                    <div class="status-change-popup__status-change-block">
                        <div class="status-change-popup__status-info">
                            <p class="status-change-popup__status-value">${
								obj.oldStatus
							}</p>
                        ...
                        <div class="status-change-popup__additional-info">
                            <p class="status-change-popup__changer">${
								obj.editor
							}</p>
