...
function updateNavigation(activeClass) {
  ...
  switch (activeClass) {
    case "main-content_table_user-table":
      document
        .querySelector('.header__navigation-item[onclick="openUsers()"]')
        .classList.add("header__navigation-item_selected");
      break;
    case "main-content_table_application-table":
      document
        .querySelector('.header__navigation-item[onclick="openApplications()"]')
        .classList.add("header__navigation-item_selected");
      break;
    case "main-content_table_account-table":
      document
        .querySelector('.header__navigation-item[onclick="openAccounts()"]')
        .classList.add("header__navigation-item_selected");
      break;
    case "main-content_table_session-table":
      document
        .querySelector('.header__navigation-item[onclick="openSessions()"]')
        .classList.add("header__navigation-item_selected");
      break;
  }
}
