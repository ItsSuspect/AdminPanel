    ...
    slice.forEach(income => {
        const incomeHtml = `
            <div class="table__row">
                ...
                <div class="table__cell table__cell_content_price">
                    <p class="table__cell-text">${income.price.toFixed(2)}$</p>
                </div>
                <div class="table__cell table__cell_content_discount">
                    <p class="table__cell-text">${income.discount.toFixed(2)}%</p>
                </div>
                <div class="table__cell table__cell_content_discounted-price">
                    <p class="table__cell-text">${income.discountedPrice.toFixed(2)}$</p>
                </div>
                <div class="table__cell table__cell_content_partner">
                    <p class="table__cell-text">${income.partner}</p>
                </div>
                <div class="table__cell table__cell_content_partner-percentage">
