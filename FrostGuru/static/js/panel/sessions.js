...
async function loadMoreSessions() {
    ...
    if (searchSessions) {
        ...
        if (slice.length > 0) {
            ...
            document.getElementById('loadMoreSessionsBtn').style.display = 'none';
        }
    } else {
        try {
...
async function searchTableSessions(event) {
    ...
    let input = document.getElementById('searchInputSessions').value.toLowerCase();
    const tableContentSessions = document.getElementById('tableContentSessions');
